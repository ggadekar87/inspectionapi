...
namespace api.Controllers
{
    ...
    public class InspectionController : ControllerBase
    {
        ...
        {
            var result = await _inspectionService.GetInspections(page, pageSize, truckNumber, driverName, status, portOfEntry, purpose);
            return Ok(new
            {
                data = result.Data,
                total = result.Total
        ...
        //    //await _unitOfWork.TruckAppointments.AddAsync(newItem);
